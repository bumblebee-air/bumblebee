																...
																<div class="col-12">
																	<div class="form-group bmd-form-group">
																		...
																		<textarea class="form-control" name="accounts_note"
																			...
																			required rows="3">{{$job->accounts_note}}</textarea>
																	</div>
																</div>
																<div class="col-12">
																				...
																				<div class="col-12 row">
																					...
																					<div class="col">
																						<div class="form-check form-check-radio">
																							<label class="form-check-label"> <input
																								class="form-check-input" type="radio"
																								id="contractNo" name="contract" value="0"
																								required onclick="clickContract(0)"> No <span
																								class="circle"> <span class="check"></span>
																							</span>
																							</label>
																						</div>
																...
																<div class="col-12">
																	<div class="form-group bmd-form-group" id="dateDiv">
																		<label>Date</label> <input type="text" id="date"
																			...
																			value="{{$job->date}}" placeholder="Select date"
																			required>
																	</div>
																</div>
																<div class="col-12">
																	<div class="form-group bmd-form-group">
																		<label>Time</label> <input type="text" id="time"
																			...
																			value="{{$job->time}}" placeholder="Select time"
																			required>
																	</div>
																</div>
																<div class="col-12">
															...
															<div class="row">
																<div class="col-12">
																	<div class="form-group bmd-form-group">
																		<label>Email </label> <input type="text" id="email"
																			...
																			value="{{$job->email}}" placeholder="Email " required>
																	</div>
																</div>
																<div class="col-12">
																	<div class="form-group bmd-form-group">
																...
																<div class="col-12">
																	<div class="form-group bmd-form-group">
																		<label>Mobile</label> <input type="tel"
																			...
																			value="{{$job->mobile}}" placeholder="Mobile"
																			required>
																	</div>
																</div>
																<div class="col-12">
																...
																<div class="col-12 mt-2">
																	@if($job->pickup_needed) <input type="checkbox"
																		...
																		onclick="clickPickupNeeded()" checked="checked"> @else
