...
//            TwilioHelper::sendSMS('GardenHelp', $singleRequest->phone_number, $body);
    ...
    {
        $availableJobs = Customer::where('type', 'job')->whereNull('contractor_id')->where('status', '!=', 'completed')->orderBy('id', 'desc')->get();
...
//                    TwilioHelper::sendSMS('GardenHelp', $job->phone_number, $body);
    ...
    public function postDeleteContractor(Request $request, $client_id, $id = null)
    {
        $contractor_id = $id ?: $request->get('contractorId');
