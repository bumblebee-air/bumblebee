                                                                        ...
                                                                        <label class="form-check-label w-100 px-0"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-10">
                                                                                    ...
                                                                                    <p class="recommendContractorDataP" id="km-away-{{$contractor->id}}">0
                                                                                        km away</p>
                                                                                </div>
                                                                                <div class="col-2"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-center">
                                <button class="btn btn-register btn-gardenhelp-danger"
                                        ...
                                        data-target="#rejection-reason-modal">Cancel Job
                                </button>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-12">
                                                <button type="button"
                                                        ...
                                                        onclick="$('form#request-rejection').submit()">Send
                                                </button>
                                            </div>
                                ...
                                <div class="modal-content">
                                                            ...
                                                            <div class="card selected-contractor-card">
                                                                <div class="card-header deliverer-details row">
                                                                    ...
                                                                    <div class="col-10">
                                                                        ...
                                                                        <p class="recommendContractorDataP"><span
                                                                                    id="contractorLevelSpan"></span></p>
                                                                        <p class="recommendContractorDataP"><span
                                                                                    id="contractorAwaySpan"></span>
                                                                            km away</p>
                                                                    </div>
                                    ...
                                    <div class="modal-footer d-flex justify-content-around">
                                        <button type="button" class="btn btn-register btn-gardenhelp-green"
                                                onclick="$('form#assign-contractor').submit()">Assign
                                        </button>
