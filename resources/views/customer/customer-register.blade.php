...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="container-fluid">
            <h3 class="text-center text-rose" style="font-weight: 400;">Welcome to Bumblebee, please fill up below form to create an account.</h3>
            <div class="row">
                    ...
                    <div class="card match-height">
                        ...
                        <form action="{{ url('complete-registration') . '/' . $code }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group bmd-form-group">
                                    <label for="vat" style="margin-top: 5px;">VAT Number</label>
                                    <input id="vat" name="vat" type="text" class="form-control" value="{{ old('vat') }}" placeholder="Enter vat" />
                                </div>
                                ...
                                <h5 style="margin-top: 5px;">Subscription & Payment Information</h5>

                                <div class="form-group bmd-form-group">
                                    <label for="subscription_plan">Subscription Plan</label>
                                    <select id="subscription_plan" name="subscription_plan" class="form-control selectpicker">
                                ...
                                <div class="payment-information-container">
                                    <div class="form-group bmd-form-group">
                                        <label for="name_on_card" style="margin-top: 5px;">Name On Card</label>
                                        <input id="name_on_card" name="name_on_card" type="text" class="form-control" value="{{ old('name_on_card') }}" autocomplete="off" placeholder="Enter name on card" />
                                    </div>

                                    <div class="form-group bmd-form-group">
                                        <label for="card_number">Card Number</label>
                                        <input id="card_number" name="card_number" type="text" value="{{ old('card_number') }}" class="form-control" autocomplete="off" placeholder="1234 1234 1234 1234" />
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="form-group bmd-form-group">
                                                ...
                                                <input id="expiry_date" value="{{ old('expiry_date') }}" name="expiry_date" type="text" class="form-control" placeholder="MM/YY" />
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group bmd-form-group">
                                                <label for="cvc">CVC</label>
                                                <input id="cvc" name="cvc" value="{{ old('cvc') }}" type="text" class="form-control" placeholder="XXX" size="4" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
