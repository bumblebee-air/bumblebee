...
<!--                 </a></li> -->
                ...
                <li class="nav-item"><a class="nav-link d-flex"
                    href="{{route('doorder_retailers', 'doorder')}}"> <img
                        class="my-nav-icon my-nav-icon-grey"
                        src="{{asset('images/doorder-new-layout/retailers-grey.png')}}" alt=""> <img
                        class="my-nav-icon my-nav-icon-top"
                ...
                <li class="nav-item"><a class="nav-link d-flex"
                    href="{{route('doorder_drivers', 'doorder')}}"> <img
                        class="my-nav-icon my-nav-icon-grey"
                        src="{{asset('images/doorder-new-layout/drivers-grey.png')}}" alt="">
                        <img class="my-nav-icon my-nav-icon-top"
                        src="{{asset('images/doorder-new-layout/drivers-yellow.png')}}"
                        alt="">
                        <p>Deliverers</p>
                </a></li>
                ...
                <li class="nav-item"><a class="nav-link d-flex" href="{{route('doorder_getSettings', 'doorder')}}"> <img
                        ...
                        <img class="my-nav-icon my-nav-icon-top"
                        src="{{asset('images/doorder-new-layout/settings-yellow.png')}}"
                        alt="">
                        <p>Settings</p>
                </a></li>
		    ...
		    @elseif(auth()->user()->user_role == 'driver_manager')
                <li class="nav-item"><a class="nav-link d-flex"
                    ...
                    src="{{asset('images/doorder-new-layout/drivers-grey.png')}}" alt="">
                    <img class="my-nav-icon my-nav-icon-top"
                         src="{{asset('images/doorder-new-layout/drivers-yellow.png')}}" alt="">
                    <p>Deliverers</p>
                </a></li>
                <li class="nav-item"><a class="nav-link d-flex"
            ...
            <li class="nav-item "><a class="nav-link d-flex" href="{{url('logout')}}">
                <img class="my-nav-icon my-nav-icon-grey"
                     src="{{asset('images/doorder-new-layout/logout-grey.png')}}"
                     alt="">
                <img class="my-nav-icon my-nav-icon-top"
                     src="{{asset('images/doorder-new-layout/logout-yellow.png')}}"
                     alt="">
                <p>Logout</p>
            </a></li>
        </ul>
