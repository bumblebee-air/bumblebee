@extends('templates.doorder_dashboard') @section('page-styles')
	...
	<link rel="stylesheet" href="{{ asset('css/doorder-calendar-styles.css') }}">
...
@section('page-content')
				...
				<div class="row">
					<div class="col-md-12">
								...
								<div class="col-12 col-lg-7 col-md-6 col-sm-6">
									<div class="row justify-content-end float-sm-right">
										@if (auth()->user()->user_role != 'retailer')
											<ul class="nav nav-pills ordersListPills my-sm-3 mt-0 mb-1" id="pills-tab-orders" role="tablist">
												<li class="nav-item"><a class="nav-link active" id="pills-list-tab" data-toggle="pill" href="#ordersListView"
														role="tab" aria-controls="ordersListView" aria-selected="false">Switch to list view</a></li>
												<li class="nav-item"><a class="nav-link " id="pills-calendar-tab" data-toggle="pill"
														href="#ordersCalendarView" role="tab" aria-controls="ordersCalendarView" aria-selected="true">Switch
						...
						<div class="tab-content" id="pills-tab-ordersContent">
							<div class="tab-pane fade" id="ordersCalendarView" role="tabpanel" aria-labelledby="pills-calendar-tab">
								<div class="card">
													...
													<div id="filterByStatusDiv" class="calendarFilterDiv">
														...
														<div class="row " style="margin-left: -3px; margin-right: -10px;">
															...
															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel viewAllLabel" for="view-all-status"> <input
																		type="checkbox" value="all" checked="checked" class="form-check-input" id="view-all-status"
																		name="filterByStatus" /> View all <span class="form-check-sign"> <span class="check"></span>
																	</span>
																</label>
															</div>
															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel pendingStatusLabel" for="pending-status"> <input
																		type="checkbox" value="pending" class="form-check-input" id="pending-status" name="filterByStatus" />
																	Pending
																	fullfilment <span class="form-check-sign"> <span class="check"></span>
																	</span>
																</label>
															</div>
															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel readyStatusLabel" for="ready-status"> <input
																		type="checkbox" value="ready" class="form-check-input" id="ready-status" name="filterByStatus" />
																	Ready to Collect <span class="form-check-sign"> <span class="check"></span>
																	</span>
																</label>
															</div>
															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel matchedStatusLabel" for="matched-status"> <input
																		type="checkbox" value="matched" class="form-check-input" id="matched-status" name="filterByStatus" />
																	Matched <span class="form-check-sign"> <span class="check"></span>
																	</span>
																</label>
															</div>
															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel on_route_pickupStatusLabel"
																	for="on_route_pickup-status"> <input type="checkbox" value="on_route_pickup" class="form-check-input"
																		id="on_route_pickup-status" name="filterByStatus" />
																	On-route to pickup <span class="form-check-sign"> <span class="check"></span>
																	</span>
																</label>
															</div>

															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel picked_upStatusLabel" for="picked_up-status"> <input
																		type="checkbox" value="picked_up" class="form-check-input" id="picked_up-status"
																		name="filterByStatus" /> Picked up
																	<span class="form-check-sign"> <span class="check"></span>
																	</span>
																</label>
															</div>
															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel on_routeStatusLabel" for="on_route-status"> <input
																		type="checkbox" value="on_route" class="form-check-input" id="on_route-status"
																		name="filterByStatus" /> On-route <span class="form-check-sign"> <span class="check"></span>
																	</span>
																</label>
															</div>
															...
															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel delivery_arrivedStatusLabel"
																	for="delivery_arrived-status"> <input type="checkbox" value="delivery_arrived"
																		class="form-check-input" id="delivery_arrived-status" name="filterByStatus" />
																	Arrived to location <span class="form-check-sign"> <span class="check"></span>
																	</span>
																</label>
															</div>
															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel deliveredStatusLabel" for="delivered-status"> <input
																		type="checkbox" value="delivered" class="form-check-input" id="delivered-status"
																		name="filterByStatus" /> Delivered
																	<span class="form-check-sign"> <span class="check"></span>
																	</span>
																</label>
															</div>
															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel not_deliveredStatusLabel"
																	for="not_delivered-status"> <input type="checkbox" value="not_delivered" class="form-check-input"
																		id="not_delivered-status" name="filterByStatus" /> Not
																	delivered <span class="form-check-sign"> <span class="check"></span>
																	</span>
																</label>
															</div>
														</div>
													</div>
													<div id="filterByRetailerDiv" class="calendarFilterDiv" data-spy="scroll"
														data-target=".filter-retailers-container">
														...
														<div class="row filter-retailers-container  overflow-auto"
															...
															<div class="form-check col-6 col-md-12">
																<label class="form-check-label calendarFilterLabel viewAllLabel" for="view-all-retailer"> <input
																		type="checkbox" value="all" checked="checked" class="form-check-input" id="view-all-retailer"
																		name="filterByRetailer" /> View
															...
															@foreach ($retailers as $retailer)
																<div class="form-check col-6 col-md-12">
																	<label class="form-check-label calendarFilterLabel retailerStatusLabel"
																		for="retailer_{{ $retailer->id }}"> <input type="checkbox" value="{{ $retailer->id }}"
																			class="form-check-input" id="retailer_{{ $retailer->id }}" name="filterByRetailer" />
																		{{ $retailer->name }} <span class="form-check-sign"> <span class="check"></span>
																		</span>
																	</label>
																</div>
															@endforeach
							...
							<div class="tab-pane fade  show active" id="ordersListView" role="tabpanel" aria-labelledby="pills-list-tab">
											...
											<div class="table-responsive">
												<table class="table table-no-bordered table-hover doorderTable ordersListTable" id="ordersTable"
													...
													<tbody>
														...
														<tr v-for="order in orders.data" v-if="orders.data.length > 0" @click="openOrder(event,order.id)"
															class="order-row" :data-orderId="order.id">
    ...
    order.order_id : '#' + order.order_id }}</td>
															...
															<td class="text-left"><span v-if="order.status == 'pending'"
																...
																<span v-if="order.status == 'matched' || order.status == 'assigned'"
																	...
																	up</span> <span v-if="order.status == 'on_route'"
																	class="orderStatusSpan onRouteStatus">On-route</span> <span v-if="order.status == 'delivery_arrived'"
																...
																<!--                                                 	:src="'{{ asset('/') }}images/doorder_icons/order_status_' + (order.status === 'assigned' ? 'matched' :
																    order.status) + '.png'" :alt="order.status"> -->
    ...
    order.driver : 'N/A' }}</td>
															<td class="text-left">
																<p style="" class="tablePinSpan tooltipC mb-0">
																	...
																	<span class="tooltiptextC"> <i class="fas fa-circle" style="color: #747474"></i>
	...
	<script>
		...
		$(document).ready(function() {
			...
			console.log($('input[name="selectedOrders[]"]:checked'))
			////////////////////////////////////////// calendar
			var date = new Date();
			var d = date.getDate();
			var m = date.getMonth();
		...
		var app = new Vue({
			...
			mounted() {
				...
				orders_socket.on('doorder-channel:update-order-status' + '-' + '{{ env('APP_ENV', 'dev') }}', (
					data) => {
					let decodedData = JSON.parse(data);
					console.log(decodedData);
					// this.orders.data.filter(x => x.id === decodedData.data.id).map(x => x.foo);
					let orderIndex = this.orders.data.map(function(x) {
						return x.id;
					}).indexOf(decodedData.data.id)
					if (orderIndex != -1) {
