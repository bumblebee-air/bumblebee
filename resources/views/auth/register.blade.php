    ...
    <div class="row">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    <h5 class="card-title text-center">Bumblebee user registration</h5>
                    <form class="form-signin" method="POST" action="{{url('register')}}">
                        ...
                        <div class="form-label-group">
                            <input type="password" id="repeat-password" name="password_confirmation" class="form-control" placeholder="Repeat Password" required>
