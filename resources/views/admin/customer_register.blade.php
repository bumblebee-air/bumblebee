        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            ...
            <div class="card card-signin my-1">
                <div class="card-body">
                    ...
                    <form class="form-signin" method="POST" action="{{url('admin/customer-register')}}">
                        {{csrf_field()}}
                        ...
                        <div class="form-label-group">
                            <input id="phone" class="form-control" name="phone" placeholder="Phone number" required autofocus>
