			...
			<div class="row">
				<div class="col-md-12">
					...
					<form id="productTypeForm" method="POST"
						action="{{route('unified_postProductTypeSingleEdit', ['unified',$productType->id])}}"
						...
						<div class="card">
							<div class="card-header card-header-icon  row">
								<div class="col-12 col-md-8">
									...
									<h4 class="card-title customerProfile">Product Type / {{$productType->name}}</h4>
								</div>
								<div class="col-6 col-md-4 mt-4">
									<div class="row justify-content-end">
										@if($readOnly==1)
										<a class="btn btn-unified-primary btn-import w-auto"
											href="{{url('unified/product_types/edit')}}/{{$productType->id}}">
											Edit product type </a>
										@endif	
									</div>
										...
										<div class="col-md-6">
											<div class="form-group bmd-form-group">
												<label>Name</label> <input type="text" class="form-control"
													name="product_type_name" placeholder="Name" required value="{{$productType->name}}">
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group bmd-form-group">
												<label style="display: table-cell;">Color</label> <input
													type="color" class="inputColor" name="borderColor" id="color"
													 required onchange="changeColor()" value="{{$productType->borderColor}}">
													<input type="hidden" name="backgroundColor" id="backgroundColor" value="{{$productType->backgroundColor}}"> 
												<div class="productColorDiv" style="background: {{$productType->backgroundColor}};
												    border-color:{{$productType->borderColor}}"></div>
											</div>
										</div>
						...
						<div class="row ">
							...
							<div class="col-md-4 text-center">
								<button class="btn btn-unified-danger singlePageButton"
									...
									data-target="#delete-productType-modal">Delete</button>
							</div>
						</div>
					</form>
					@endif
...
$( document ).ready(function() {
          	...
          	var options = {
                ...
                disabledAttrs: [
                    'access','other','className','value'//,'name'
                ],
