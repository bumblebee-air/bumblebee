@extends('templates.garden_help-dashboard') @section('page-styles')
...
<div class="content">
	<div class="container">
		<div class="row">
			...
			<div class="card changePasswordDiv mt-0" id="dashboardCardDiv">
				<div class="card-body">
					<form
						...
						<div class="row justify-content-center">
							<div class="col-lg-3  col-md-3 col-sm-4 px-md-1 text-center">
								<button type="submit"
									class="btn btn-submit btn-gardenhelp-green mb-1">Submit</button>
							</div>
						</div>
					</form>
				</div>
