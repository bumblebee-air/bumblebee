@extends('templates.dashboard') @section('title', 'GardenHelp | Edit
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header card-header-icon card-header-rose">
								...
								<h4 class="card-title ">Property No. {{$property->id}}</h4>
							</div>
							<div class="card-body">
								<div class="container">
									<div class="row">
															...
															<div class="row">
																<div class="col">
																	...
																	<div class="form-check">
																		<label class="form-check-label"> <input
																			...
																			name="type_of_work" value="Residential"
																			@if($property->type_of_work=='Residential') checked
																			@endif >Residential <span class="form-check-sign"> <span
																				class="check"></span>
																		</span>
																		</label>
																	</div>
																...
																<div class="col">
																	...
																	<div class="form-check">
																		<label class="form-check-label"> <input
																			class="form-check-input" type="radio"
																			name="type_of_work" value="Commercial" @if($property->type_of_work=='Commercial')
																			checked @endif >Commercial <span
														...
														<div class="form-group ">
															...
															<div class="input-group">
																...
																<textarea class="form-control" id="location"
																	name="location" rows="2" required>{{$property->location}}</textarea>
																<input type="hidden" id="location_coordinates"
																	name="location_coordinates"
																	value="{{$property->location_coordinates}}">
															</div>
														</div>
													</div>
													<div class="col-md-12 ">
														...
														<div class="form-group bmd-form-group">
															...
															<div class="d-flex justify-content-between">
																<textarea name="notes" rows="5" class="form-control"
																	id="notes">{{$property->notes}}</textarea>
															</div>
														</div>
													</div>
...
console.log(property.work_location)

    $(document).ready(function() {
       // $(".js-example-basic-single").select2();
        $("#work_location").select2();
        $("#work_location").val(property.work_location).trigger('change');
    });
        ...
        var app = new Vue({
            ...
            data: {
                ...
                site_details: [
                    {
                        title: 'Pets',
                        is_checked:  {{ strpos($property->site_details, 'Pets') === false ? 'false' :  'true' }},
                    ...
                    },
                    {
                        ...
                        is_checked:  {{ strpos($property->site_details, 'Underground Electrical Cable') === false ? 'false' :  'true' }},
                    ...
                    },
                    {
                        ...
                        is_checked:  {{ strpos($property->site_details, 'Over Ground Electrical Cable') === false ? 'false' :  'true' }},
                        //is_checked: JSON.parse("{{old('site_details') ? ( strpos(old('site_details'), 'Over Ground Electrical Cable') === false ? 'false' : 'true' ) : 'false'}}"),
                    },
                    {
                        title: 'Water Mains',
                        is_checked:  {{ strpos($property->site_details, 'Water Mains') === false ? 'false' :  'true' }},
                        //is_checked: JSON.parse("{{old('site_details') ? ( strpos(old('site_details'), 'Water Mains') === false ? 'false' : 'true' ) : 'false'}}"),
                    },
                    {
                        title: 'Gas Mains',
                        is_checked:  {{ strpos($property->site_details, 'Gas Mains') === false ? 'false' :  'true' }},
                    ...
                    },
                    {
                        ...
                        is_checked:  {{ strpos($property->site_details, 'Metered Parking Area') === false ? 'false' :  'true' }},
                        //is_checked: JSON.parse("{{old('site_details') ? ( strpos(old('site_details'), 'Metered Parking Area') === false ? 'false' : 'true' ) : 'false'}}"),
                    },
                ],
                is_first_time: '',
                is_parking_site: property.is_parking_access,
                contact_through: '',
                service_types_input: '',
                site_details_input: property.site_details,
...
//                         }
       ...
       //Map Js
        ...
        let area_coordinates = property.area_coordinates ;
        let polygon;
...
// 			});
        ...
        window.initMap = function initMap(){
            ...
            let locationMarker = new google.maps.Marker({
                map: this.map,
                icon: marker_icon,
                position: JSON.parse(property.location_coordinates)
            });
