												...
												<div class="timeline-carousel__item">
													<div class="contractor-card text-center">
														...
														<button type="button"
																...
																onclick="showAssignContractorModal({{$contractor}})">
															<p>BOOK NOW</p>
														</button>
													</div>
												</div>
...
// 		    });
		...
		function showAssignContractorModal(contractor) {
			{{--			{{$contractor->id}},'{{$contractor->name}}','{{$contractor->experience_level}}', '{{$contractor->bidding[0]->estimated_quote}}'--}}
...
// 			$('#contractorPriceQuotation').html(price_quotation);
			...
			$('#contractorNameSpan').html(contractor.name);
			$('#contractorLevelSpan').html(contractor.experience_level);
			$('#contractorAwaySpan').html($("#hiddenKmAway-"+contractor.id).val());
			$('#contractorPriceQuotation').html(contractor.bidding[0].estimated_quote);
		}
