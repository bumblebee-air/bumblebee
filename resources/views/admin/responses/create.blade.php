        ...
        <form action="{{url('response')}}" method="post">
          <div class="card-body">
            ...
            <div class="form-group bmd-form-group">
              ...
              <br />
              <div class="keywords-badges info-badge"></div>
              <input type="hidden" name="audio_keywords" id="audio-keywords" value="" />
              <select title="Select Keywords" data-style="select-with-transition" data-live-search="true" name="keywords[]" id="keywords" class="selectpicker" multiple>
