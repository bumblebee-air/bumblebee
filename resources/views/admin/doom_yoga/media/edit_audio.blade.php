...
<div class="content">
	<div class="container-fluid">
		<div class="container-fluid">
			<form action="{{route('doomyoga_postEditAudio', 'doom-yoga')}}"
				method="POST" id="addAudioForm" enctype="multipart/form-data"
				autocomplete="off">
				{{csrf_field()}}
				<div class="row">
					<div class="col-md-12">
										...
										<div class="col-md-6">
											<div class="form-group bmd-form-group">
												<label class="formLabel">Title</label> <input type="text"
													class="form-control" name="title" value="{{$audio->name}}" required>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group bmd-form-group">
												...
												<input type="hidden" name="duration" id="duration" value="{{$audio->length}}">
